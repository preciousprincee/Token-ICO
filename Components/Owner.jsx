    ...
    <div className="container">
      <div className="new-owner team__wrap ul_li">
        <div className="team__item">
          ...
          <div className="item__social ul_li_center">
        ...
        </div>
        {
          account ==detail?.owner && (
            <>
              ...
              <div className="item__social ul_li_center">
                <span onClick={() => (setOwnerModel(false), setOpenUpdateAddress(true)) }
                  className="h-icon"
                  style={{
                    cursor: "pointer",
                  }}>
              ...
              <div className="item__social ul_li_center">
                <span onClick={() => (setOwnerModel(false), setOpenUpdatePrice(true)) }
                  className="h-icon"
                  style={{
                    cursor: "pointer",
                  }}>
