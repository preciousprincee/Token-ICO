   ...
   return( <section className="new-margin ico-contact pos-rel">
     <div className="container">
       ...
       <div className="row">
         ...
         <input type="text" 
               placeholder={`Token Balance: ${transferToken?.balance} 
         ...
         <div className="col-lg-12">
           ...
           placeholder={`CurrentPrice: ${detail?.tokenBal} ${detail?.symbol}  Token Address:${detail?.tokenBal} ${shortenAddress(detail?.tokenAddr)} `}>
         ...
         <div className="ico-contact__btn text-center mt-10">
           <button onClick={() => BUY_TOKEN 
             (amount)} className="thm-btn">
               Buy Token
             </button>
         </div>
       </div>
